                    ...
                    <td className="py-4 px-6 text-right">
                      {user.role !== 'admin' && (
                        <button 
                          ...
                          className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-transparent hover:bg-red-500/10 text-[#8c909f] hover:text-red-400 text-sm font-medium rounded-lg transition-all opacity-0 group-hover:opacity-100 focus:opacity-100"
                        >
